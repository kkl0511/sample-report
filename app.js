    ...
    <div class="card p-3" style="background: #0b1220;">
      <svg viewBox="0 0 800 520" width="100%" preserveAspectRatio="xMidYMid meet" style="max-height: 520px;">
        ...
        <g>
          ...
          <rect x="592" y="110" width="180" height="60" rx="6" fill="#0b1220" stroke="${taColor}" stroke-opacity="0.85" stroke-width="2"/>
        ...
        <g>
          ...
          <rect x="582" y="210" width="200" height="64" rx="6" fill="#0b1220" stroke="${afColor}" stroke-opacity="0.85" stroke-width="2"/>
        ...
        <!-- ★ v32.9 — 누수 0개 시 중앙에 ✅ 메시지 -->
        ${(!ptLeak && !taLeak && !afLeak && !flyingOpen && !kneeCollapse && driveStatus === 'normal') ? `
        <g>
          <rect x="280" y="495" width="400" height="48" rx="8" fill="#0b1f12" stroke="#4ade80" stroke-opacity="0.8" stroke-width="2"/>
          <text x="480" y="515" fill="#4ade80" font-size="14" font-family="Inter" font-weight="800" text-anchor="middle" letter-spacing="1">✅ 키네틱 체인 정상</text>
    ...
    if (faults.length > 0) {
      ...
      const faultRows = faults.map(f => {
        ...
        const visualBlock = guide ? `
          <details class="mt-2" style="background:#0b1220; border:1px solid var(--border); border-radius:6px;">
